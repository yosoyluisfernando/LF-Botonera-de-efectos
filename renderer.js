...
// CAMBIO AQUÍ: Prioridad máxima a la tecla Escape para salir de mapeo
document.addEventListener('keydown', (e) => {
  ...
  if (e.key === 'Escape') {
      ...
      // PRIORIDAD 1: SIEMPRE salir de mapeo con ESC
      if (isMappingMode) { 
        salirModoMapeo(); 
        handled = true; 
      }
      
      else if (!captureModal.classList.contains('hidden')) { captureModal.classList.add('hidden'); handled = true; }
